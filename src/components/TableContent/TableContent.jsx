...
'Aksha Enterprises dealt in the realm of Civil Construction, Fabrication & Painting, Operation & Maintenance, Manpower Supply, Earthmovers, Crane Supply, and Electrical Works';

const headerTagForCities = 'We provide services in below cities in India';
const headerforManufacturer = 'AKSHA PERFORMING AREAS IN';
const TableContent = () => {
  const textVariants = {
    initial: {
      x: -500,
